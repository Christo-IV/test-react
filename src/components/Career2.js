    ...
    return (
      ...
      <div class="part2"> 
          ...
          <div class="careerintro">
            <p>
            IT-süsteemide spetsialist on hinnatud ning laiahardega spetsialist kogu maailmas. 
IT-süsteemide spetsialisti õpilasena on Su nädal alati sisustatud ning igavlema ei pea. 
Tegeled IT-taritu arendamisega ja arvutisüsteemidega, kuid Sulle ei jää võõraks ka kood.
Samuti julgustab VOCO IKT-osakond alati õpilasi tegelema oma projektidega ning saama kogemust väljapoolt kooli.
Muidugi on selleks ka prakitikad, kuid miks mitte teha midagi lahedat koos tiimiga või iseseisvalt?
...
Kui Sul on tahe ja soov olla tuleviku IT-süsteemide spetsialist, siis see eriala on just sulle!
</p>

<h1> Vastuvõtutingimused on: </h1>
<li>individuaalvestlus või grupivestlus;</li>
<li>kutsesobivustest, mis hindab edukaks erialaseks tööks vajalikke isikuomadusi ja võimekust: matemaatiline võimekus, funktsionaalne lugemisoskus, taju, tähelepanu, keskendumisvõime, mälu;</li>
<li>praktiline ülesanne – enne vastuvõtu katseid tuleb läbida konkreetne Codecademy kursus::</li>
<a target="_blank" href="https://www.codecademy.com/learn/learn-the-command-line">https://www.codecademy.com/learn/learn-the-command-line</a>
...
<li>motivatsioonikiri – palume motivatsioonikirja lõppu lisada Codecademy kasutajanimi.</li>
        ...
        <div id="dub-arrow"><img src="https://cdn-icons-png.flaticon.com/512/2942/2942924.png" alt="" /></div>
        <a href="#">ASTU SISSE!</a>
        </div>
